...
class ProducerTest {
    ...
    @BeforeEach
    void setUp() {
        instance = Producer.builder().debugMode(false).messageCount(20).build();
    }
    ...
    void build() {
        assertAll("build", () -> assertNotNull(Producer.builder().build()),
                () -> assertNotNull(Producer.builder().debugMode(true).build()),
                () -> assertNotNull(Producer.builder().debugMode(false).build()),
                () -> assertNotNull(Producer.builder().messageCount(20).build()),
                () -> assertNotNull(Producer.builder().debugMode(true).messageCount(20).build()));
    }
